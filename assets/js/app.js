...
function displayMeteo(data){
    ...
    $('#meteo-title span').html('Weather prediction in the city <a href="' + googleMapCity + '" class="text-muted meteo-city" target="_blank">' + data.city.name + ', ' + data.city.country + '</a>');
